...
class MAGNOConfig:
    ...
    # --- Dynamic Radius ---
    radius_mode: str = "fixed"                              # Radius mode: ["fixed", "dynamic"]
    dynamic_radius_k: int = 10                              # Number of neighbors for dynamic radius calculation
    dynamic_radius_alpha: float = 1.2                       # Scaling factor for dynamic radius calculation
